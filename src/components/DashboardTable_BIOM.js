          ...
          <StyledTable className="flex flex-1 justify-center ">
            ...
            <TableBody>
                ...
                <TRow >
                  ...
                  <TableCell>Arunkumar</TableCell>
                  <TableCell>Ram</TableCell>
                  <TableCell>arunkumar.ram@vit.edu.in</TableCell>
                  <TableCell>BIOM</TableCell>
                  <TableCell>
                    <Box sx={{ p: 1, display: 'flex' }}>
                      <FiberManualRecordIcon
                        fontSize="small"
                ...
                <TRow >
                  ...
                  <TableCell>Neelam</TableCell>
                  <TableCell>Punjabi</TableCell>
                  <TableCell>neelam.punjabi@vit.edu.in</TableCell>
                  <TableCell>BIOM</TableCell>
                  <TableCell>
                    <Box sx={{ p: 1, display: 'flex' }}>
                      <FiberManualRecordIcon
                ...
                <TRow >
                  ...
                  <TableCell>Priyanka</TableCell>
                  <TableCell>Shrivastava</TableCell>
                  <TableCell>priyanka.shrivastava@vit.edu.in</TableCell>
                  <TableCell>BIOM</TableCell>
                  <TableCell>
                    <Box sx={{ p: 1, display: 'flex' }}>
                      <FiberManualRecordIcon
