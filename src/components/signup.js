          ...
          <div className="w-full max-w-md space-y-8">
            <div>
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                Or{' '}
                <a href="/" className="font-medium text-red-600 hover:text-orange-500">
              ...
              <div>
                ...
                >
                  <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                    <LockClosedIcon className="h-5 w-5 text-red-300 group-hover:text-red-100" aria-hidden="true" />
                  </span>
                  Sign in
                </button>
              </div>
